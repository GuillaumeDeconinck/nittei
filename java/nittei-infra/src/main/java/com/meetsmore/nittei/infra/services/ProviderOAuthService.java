...
public class ProviderOAuthService implements ProviderOAuth {
    ...
    public ProviderOAuthService(GoogleOAuthService googleOAuthService, OutlookOAuthService outlookOAuthService) {
        this.googleOAuthService = googleOAuthService;
        this.outlookOAuthService = outlookOAuthService;
    }

    public CodeTokenResponse exchangeCodeToken(IntegrationProvider provider, CodeTokenRequest request) {
