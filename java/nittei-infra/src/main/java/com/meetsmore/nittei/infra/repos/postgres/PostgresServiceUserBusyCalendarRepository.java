...
public class PostgresServiceUserBusyCalendarRepository implements ServiceUserBusyCalendarRepository {
    ...
    public List<BusyCalendarProvider> find(ID serviceId, ID userId) {
        return jdbcTemplate.query(
            ...
            """,
            (rs, rowNum) -> new BusyCalendarProvider(rs.getString("provider"), rs.getString("calendar_id")),
            toUuid(serviceId),
            toUuid(userId),
            toUuid(serviceId),
            toUuid(userId)
