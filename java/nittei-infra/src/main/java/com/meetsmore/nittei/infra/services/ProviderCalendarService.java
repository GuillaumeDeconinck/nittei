...
public class ProviderCalendarService {
    ...
    public List<GoogleCalendarListEntry> listGoogleCalendars(
        User user,
        GoogleCalendarAccessRole minAccessRole,
        NitteiContext ctx
    ) {
        ...
        GoogleCalendarAccessRole accessRole = minAccessRole == null
            ? GoogleCalendarAccessRole.READER
            : minAccessRole;
    ...
    public List<OutlookCalendar> listOutlookCalendars(
        User user,
        OutlookCalendarAccessRole minAccessRole,
        NitteiContext ctx
    ) {
        ...
        OutlookCalendarAccessRole accessRole = minAccessRole == null
            ? OutlookCalendarAccessRole.READER
            : minAccessRole;
