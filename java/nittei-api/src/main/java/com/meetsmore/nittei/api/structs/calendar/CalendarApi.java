...
public final class CalendarApi {
    ...
    public record GetCalendarEventsAPIResponse(
        CalendarDtos.CalendarDTO calendar,
        List<EventDtos.EventWithInstancesDTO> events
    ) {
        public static GetCalendarEventsAPIResponse from(Calendar calendar, List<EventWithInstances> events) {
    ...
    public record GetCalendarsByMetaQueryParams(String key, String value, Integer skip, Integer limit) {
    }
    ...
    public record UpdateCalendarRequestBody(UpdateCalendarSettings settings, String name, Object metadata) {
    }
}
