...
public final class EventApi {
  ...
  public record CreateEventRequestBody(
      @JsonDeserialize(using = StrictIdDeserializer.class) @NotNull ID calendarId,
      String title,
      String description,
      String eventType,
  ...
  public record GetEventInstancesAPIResponse(
      EventDtos.CalendarEventDTO event, List<EventInstance> instances) {}
  ...
  public record GetEventsByCalendarsQueryParams(
      List<ID> calendarIds, Instant startTime, Instant endTime) {}
  ...
  public record GetEventsForUsersInTimeSpanAPIResponse(
      List<EventDtos.EventWithInstancesDTO> events) {}

  public record SearchEventsRequestBody(
      SearchEventsRequestBodyFilter filter, CalendarEventSort sort, Integer limit) {}
  ...
  public record AccountEventRemindersDTO(EventDtos.CalendarEventDTO event, String identifier) {
    public static AccountEventRemindersDTO from(AccountEventReminder value) {
      return new AccountEventRemindersDTO(
          EventDtos.CalendarEventDTO.from(value.event()), value.identifier());
    }
  }
  ...
  public record AccountRemindersDTO(List<AccountEventRemindersDTO> reminders) {
    public static AccountRemindersDTO from(AccountReminders value) {
      List<AccountEventRemindersDTO> items =
          value.reminders().stream().map(AccountEventRemindersDTO::from).toList();
