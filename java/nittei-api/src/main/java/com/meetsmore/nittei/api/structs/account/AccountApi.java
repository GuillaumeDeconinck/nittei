...
public final class AccountApi {
  ...
  public record CreateAccountResponseBody(AccountDtos.AccountDTO account, String secretApiKey) {
    public static CreateAccountResponseBody from(Account account) {
      return new CreateAccountResponseBody(
          AccountDtos.AccountDTO.from(account), account.secretApiKey());
    }
  }

  public record SetAccountPubKeyRequestBody(@NotBlank String publicJwtKey) {}

  public record SetAccountWebhookRequestBody(@NotBlank String webhookUrl) {}
  ...
  public record AccountSearchEventsRequestBody(
      AccountSearchEventsRequestBodyFilter filter, CalendarEventSort sort, Integer limit) {}
